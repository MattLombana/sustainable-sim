...
class Game:
    ...
    start = gn("Hey there! Thanks for checking out our game for" +
        "BigRed//Hacks. It was made with love and sustainability in mind.\n" + 
        "Please keep in mind: we will be using your laptop camera to take photos of you" + 
        " during the game. We hope you have fun exploring!", "./assets/images/High School.jpg")
